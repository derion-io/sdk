    ...
    JsonRpcProvider.prototype.prepareRequest = function (method, params) {
        switch (method) {
            ...
            case "call": {
                ...
                if (params.stateOverride && Object.keys(params.stateOverride).length > 0) {
                    return ["eth_call", [hexlifyTransaction(params.transaction, { from: true }), params.blockTag, JsonRpcProvider.hexlifyStateOverride(params.stateOverride)]];
                }
