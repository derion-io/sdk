...
exports.powX128 = exports.xr = exports.thousandsInt = exports.formatPercentage = exports.formatQ128 = exports.mergeTwoUniqSortedLogs = exports.compareLog = exports.SHL = exports.DIV = exports.WEI = exports.IEW = exports.round = exports.truncate = exports.BIG = exports.NUM = exports.STR = exports.kx = exports.rateFromHL = exports.rateToHL = exports.mergeDeep = exports.parseUq128x128 = exports.detectDecimalFromPrice = exports.add = exports.max = exports.div = exports.sub = exports.mul = exports.formatPercent = exports.formatFloat = exports.getNormalAddress = exports.formatMultiCallBignumber = exports.decodePowers = exports.numberToWei = exports.weiToNumber = void 0;
...
exports.div = div;
const max = (a, b) => ((0, _1.bn)((0, exports.numberToWei)(a)).gt((0, exports.numberToWei)(b)) ? a : b);
exports.max = max;
const add = (a, b) => {
    a = a.toLocaleString(['en-US', 'fullwide'], { useGrouping: false });
    b = b.toLocaleString(['en-US', 'fullwide'], { useGrouping: false });
...
const detectDecimalFromPrice = (price) => {
    if (Number(price || 0) === 0 || Number(price || 0) >= 1) {
        ...
        const rate = !(0, _1.bn)((0, exports.numberToWei)(price)).isZero() ? (0, exports.weiToNumber)(ethers_1.BigNumber.from((0, exports.numberToWei)(1, 36)).div((0, exports.numberToWei)(price)).toString()) : '0';
...
const rateToHL = (r, power, DURATION = constant_1.SECONDS_PER_DAY) => {
    if (r === 0)
        return 0;
    return Math.ceil((DURATION * Math.LN2) / power / r);
};
exports.rateToHL = rateToHL;
const rateFromHL = (HL, power, DURATION = constant_1.SECONDS_PER_DAY) => {
    if (HL === 0)
        return 0;
...
function formatQ128(n, PRECISION = 10000) {
    if (n.isNegative()) {
        return -formatQ128((0, _1.bn)(0).sub(n));
    }
...
function xr(k, r, v) {
    try {
        const x = (0, exports.NUM)((0, exports.DIV)(r, v));
