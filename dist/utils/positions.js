...
function calcPoolInfo(pool) {
    ...
    const xA = (0, helper_1.xr)(K, R.shr(1), a);
    const xB = (0, helper_1.xr)(-K, R.shr(1), b);
    ...
    sides[C].k = Number((0, helper_1.IEW)(rA
        ...
        .div(rA.add(rB))));
    const interestRate = (0, helper_1.rateFromHL)(INTEREST_HL, K);
    const maxPremiumRate = (0, helper_1.rateFromHL)(PREMIUM_HL, K);
    if (maxPremiumRate > 0) {
        if (rA.gt(rB)) {
...
function calcPositionState(position, pools, currentPriceR, balance = position.balance) {
    ...
    const L = side == A ? (0, helper_1.NUM)(leverage) : side == B ? -(0, helper_1.NUM)(leverage) : 0;
    const result = {
        poolAddress,
        side,
        balance,
    ...
    if (L != 0) {
        ...
        const powerPriceRate = (0, helper_1.powX128)(priceRate, L);
...
function formatPositionView(pv) {
    const res = {
        ...
        pool: pv.poolAddress,
        balance: (0, helper_1.thousandsInt)(pv.balance.toString(), 6),
        entryPrice: (0, helper_1.formatQ128)(pv.entryPrice),
        currentPrice: (0, helper_1.formatQ128)(pv.currentPrice),
        entryValueR: (0, helper_1.thousandsInt)(pv.entryValueR.toString(), 6),
        valueR: (0, helper_1.thousandsInt)(pv.valueR.toString(), 6),
        entryValueU: (0, helper_1.thousandsInt)(pv.entryValueU.toString(), 6),
        valueU: pv.valueU ? (0, helper_1.thousandsInt)(pv.valueU.toString(), 6) : 'missing reserve token price',
        range: [(0, helper_1.formatQ128)(pv.deleveragePriceB), (0, helper_1.formatQ128)(pv.deleveragePriceA)],
        fundingRate: (0, helper_1.formatPercentage)(pv.funding),
    };
    if (pv.netPnL) {
        res.netPnL = (0, helper_1.formatPercentage)((0, helper_1.formatQ128)(pv.netPnL));
    }
    if (pv.simPnL) {
        res.simPnL = {
            linear: (0, helper_1.formatPercentage)((0, helper_1.formatQ128)(pv.simPnL.linear)),
            power: (0, helper_1.formatPercentage)((0, helper_1.formatQ128)(pv.simPnL.power)),
            powerBenefit: (0, helper_1.formatPercentage)((0, helper_1.formatQ128)(pv.simPnL.powerBenefit)),
            fundingPaid: (0, helper_1.formatPercentage)((0, helper_1.formatQ128)(pv.simPnL.funding)),
        };
    }
    return res;
}
